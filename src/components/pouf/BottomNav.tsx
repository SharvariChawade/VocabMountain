  ...
  return (
    <nav className="pouf-bottomnav" aria-label="Main">
      ...
      <RDialog.Root open={open} onOpenChange={setOpen}>
         <RDialog.Trigger asChild><button type="button" className={clsx('pouf-tab', !onPrimary && 'pouf-tab--active')} aria-current={!onPrimary ? 'page' : undefined}><Icon name="menu" size="md" /><span className="pouf-tab__label">Menu</span></button></RDialog.Trigger>
        <RDialog.Portal>
          ...
          <RDialog.Content className="pouf-sheet" aria-describedby={undefined}>
            <div className="pouf-sheet__handle" />
             <RDialog.Title asChild><Heading level={3}>All screens</Heading></RDialog.Title>
            ...
            <div className="pouf-sheet__body">
             ...
             <RDialog.Close asChild><button type="button" className={buttonClasses({ size: 'sm', variant: 'quiet', block: true })}><Row gap={2} wrap={false}>
                                         <Icon name="close" size="sm" />
                                         <Text size="sm">Close</Text>
                                       </Row></button></RDialog.Close>
          </RDialog.Content>
        </RDialog.Portal>
      </RDialog.Root>
    </nav>
